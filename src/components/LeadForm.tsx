...
import { Zap, HelpCircle, Loader2, ArrowRight, ArrowLeft, Shield, FileText, Search, Phone, TrendingDown, Leaf, Users } from "lucide-react";
...
const facts = [
  {
    icon: TrendingDown,
    stat: "Op til 30%",
    label: "Danske husstande kan spare op til 30% ved at skifte elselskab",
  },
  {
    icon: Users,
    stat: "2.7 mio.",
    label: "Danske husstande har mulighed for frit at vælge elselskab",
  },
  {
    icon: Leaf,
    stat: "100% grøn",
    label: "Mange elselskaber tilbyder nu strøm fra vedvarende energi",
  },
];
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-start">
              ...
              {steps.map((s, index) => (
                <div key={s.number} className="flex gap-4 items-start group">
                  <div className="flex flex-col items-center">
                    <div className="w-12 h-12 rounded-2xl gradient-primary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <s.icon className="w-5 h-5 text-primary-foreground" />
                    </div>
                    {index < steps.length - 1 && (
                      <div className="w-0.5 h-8 bg-gradient-to-b from-primary/30 to-transparent mt-2" />
                    )}
                  </div>
                  <div className="pt-1">
          ...
          <div className="lg:col-span-3">
            ...
            <form
              ...
              className="bg-card/95 backdrop-blur-md rounded-2xl shadow-card-hover p-8 md:p-10 border border-border/50"
            >
              {/* Step 1: Boliginfo */}
              {step === 1 && (
